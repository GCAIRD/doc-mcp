...
PROJECT_INSTRUCTIONS = {
	"spreadjs": (
		...
		"You MUST search and fetch the relevant documentation before writing ANY SpreadJS code.\n"
		"\n"
		"Framework integration - MANDATORY searches before writing code:\n"
		"- Adding SpreadJS to a project: search \"add SpreadJS to {framework} app\"\n"
		"- Adding SpreadJS Designer: search \"add SpreadJS designer to {framework} app\"\n"
		"- Always fetch the top result and follow the documented patterns exactly.\n"
		"\n"
