...
import { createIndexer } from './rag/indexer.js';
...
async function embedProduct(
	...
	const rawDataDir = join(PROJECT_ROOT, 'raw_data', config.variant.raw_data);
	...
	const indexer = createIndexer({
		...
		checkpointPath: join(PROJECT_ROOT, 'storage', `checkpoint-${productId}.json`),
		logger,
	});
